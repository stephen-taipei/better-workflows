...
[查看官方文件](https://betterworkflows.dev/docs/) · [開啟 GitHub](https://github.com/stephen-taipei/better-workflows) · [透過 Ko-fi 單次贊助](https://ko-fi.com/betterworkflows)
...
- [Evidence Cinema](https://betterworkflows.dev/docs/evidence-cinema/)

- [`DETAILS · zh-Hant-TW`](../details/zh-TW.md)
- [`README · en`](../../README.md)
...
單次贊助將用於開源維護、文件、41 個在地化版本與網站託管；不包含會員資格，也不提供開發規劃或技術支援優先權。
