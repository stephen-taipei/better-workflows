...
현재 소스에 바인딩되어 여전히 유효한 증거, 리뷰 게이트, 소스 바인딩, provider 상태 대조를 갖춘 오픈 소스 목표 우선 에이전트 워크플로 제어 플레인입니다.
...
- **02 · `evidence`** — 현재 소스에 바인딩되어 여전히 유효한 증거, 리뷰 게이트, 소스 바인딩, provider 상태 대조를 갖춘 오픈 소스 목표 우선 에이전트 워크플로 제어 플레인입니다.
