...
`$HOME/.gemini/extensions/better-workflows`. Verify the manifest, version, and
...
Run `node "<extension-root>/plugins/better-workflows/scripts/sbw.mjs" host doctor gemini-cli`,
